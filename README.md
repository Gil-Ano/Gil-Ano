...
|---------|-------------|-------|
| [**ClarixAI**](https://github.com/Gil-Ano/ai-saas) | AI SaaS dashboard with 5 tools, Stripe subscriptions, and dual microservice architecture | React · Node.js · FastAPI · PostgreSQL · Stripe |
...
💼 **Open to remote full stack and software engineering roles** — available immediately.
